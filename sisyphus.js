            ...
            return {
                ...
                protect: function( targets, options ) {
                    ...
                    if ( ! params.started[ this.getInstanceIdentifier() ] ) {
                        ...
                        } else if ( self.isTinyMCEPresent() ) {
                            var intervalId = setInterval( function() {
                                if (tinymce.EditorManager.editors.length != 0) {
                ...
                isTinyMCEPresent: function() {
                    if ( this.isTinyMCEExists() ) {
                    ...
                    self.targets.each( function() {
                        ...
                        self.findFieldsToProtect( $( this) ).each( function() {
                            ...
                            if ( field.is(":checkbox") ) {
                                ...
                                } else if ( self.isTinyMCEExists() ) {
                                    var editor;
                                    if ( editor = tinymce.EditorManager.editors[ field.attr("name") ] || tinymce.EditorManager.editors[ field.attr("id") ] ) {
                                        self.saveToBrowserStorage( prefix, editor.getContent({format : 'raw'}), false);
                                    } else {
                                        self.saveToBrowserStorage( prefix, value, false );
                                    }
                                } else {
                ...
                bindSaveDataImmediately: function( field, prefix ) {
                    ...
                    if ( this.isTinyMCEExists() ) {console.log(tinymce.EditorManager.editors);
                        var editor;
                        if ( editor = tinymce.EditorManager.editors[ field.attr("name") ] || tinymce.EditorManager.editors[ field.attr("id") ] ) {
                            editor.on( 'keyup', function() {
                                self.saveToBrowserStorage( prefix, editor.getContent({format : 'raw'}) );
                            } );
                        }
                    }
                },
