            ...
            return {
                ...
                bindSaveData: function () {
                    ...
                    self.targets.each(function () {
                        ...
                        var fieldsToProtect = $(this).find(":input[type!='hidden']").not(":submit").not(":reset").not(":button").not(":file");
                ...
                saveAllData: function () {
                    ...
                    if ($.isFunction(self.options.onBeforeSave)) {
                        self.options.onBeforeSave.call();
                    }
                ...
                restoreAllData: function () {
                    ...
                    self.targets.each(function () {
                        ...
                        var fieldsToProtect = target.find(":input[type!='hidden']").not(":submit").not(":reset").not(":button").not(":file");
